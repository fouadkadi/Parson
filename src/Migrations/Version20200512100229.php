 ...
 */
final class Version20200512100229 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reponses DROP INDEX UNIQ_1E512EC6DDEAB1A3, ADD INDEX IDX_1E512EC6DDEAB1A3 (etudiant_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reponses DROP INDEX IDX_1E512EC6DDEAB1A3, ADD UNIQUE INDEX UNIQ_1E512EC6DDEAB1A3 (etudiant_id)');
